...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent.html): add ability to ingest data via [opentelemetry](https://opentelemetry.io/docs/reference/specification/metrics/) protocol directly to `vmagent` and to single-node VictoriaMetrics. See [these docs](https://docs.victoriametrics.com/#sending-data-via-opentelemetry) and [this feature request](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/2424).
